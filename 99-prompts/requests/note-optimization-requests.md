...
> 檔案位置：`99-prompts/prompts/request/note-optimization-requests.md`
>
> 用途：存放實際向 AI 發問時，可以直接複製使用的提問內容。
>
> 建議搭配：
>
> - `99-prompts/system/ai-note-optimizer-system.md`
> - `99-prompts\workflows\note-optimization-workflow.md`
> - `99-prompts/formats/note-output-formats.md`
...
- 基本規則：`99-prompts/system/ai-note-optimizer-system.md`
- 工作流程：`99-prompts\workflows\note-optimization-workflow.md`
- 輸出格式：`99-prompts/formats/note-output-formats.md`
